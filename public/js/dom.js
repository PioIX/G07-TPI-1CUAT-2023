...
async function questionFetch(data){
  try {
    ...
    document.getElementById(`question${data.id}`).style.border = "solid blue 3px"
...
function showEndGame(corrects, incorrects, percent){
  const container = document.getElementById('add-questions');
  const container_form = document.getElementById('modify-questions-form');
  container.style.display = "flex"; 
  ...
  if (corrects <= 1){
    ...
    <img src="img/triste.jpg" width="500" height="500">
    <p>Sos un perro!</p>`
  } else if (corrects == 2 ||corrects == 3){
    document.getElementById("message").innerHTML=`
    <img src="img/medio.jpg" width="500" height="500">
    <p>Meh!</p>`
  } else {
    document.getElementById("message").innerHTML=`
    <img src="img/contento.jpg" width="500" height="500">
    <p>Roman esta contento!</p>`
  }
}
